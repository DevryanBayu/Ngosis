...
public class MainLaboranActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pengajuan_bahan_laboran) {
            fragmentClass = ProfilSiswaFragment.class;
        } else if (id == R.id.nav_aset_laboran) {
            fragmentClass = ProfilSiswaFragment.class;
        } else if (id == R.id.nav_laporan_aset) {
