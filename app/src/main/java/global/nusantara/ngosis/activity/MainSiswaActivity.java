...
public class MainSiswaActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_jadwal_pelajaran) {
            fragmentClass = ProfilSiswaFragment.class;
        } else if (id == R.id.nav_absensi_siswa) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_absensi_siswa_per_mapel) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_lihat_materi) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_tugas) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_nilai_tugas) {
            fragmentClass = ProfilSiswaFragment.class;

        }else if (id == R.id.nav_nilai_semester) {
            fragmentClass = TabMonitoringSiswaFragment.class;

        } else if (id == R.id.nav_view_broadcast_message) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_notifikasi_deadline_tugas) {
            fragmentClass = ProfilSiswaFragment.class;
