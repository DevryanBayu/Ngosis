...
public class MainOrangTuaSiswaActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_orang_tua_siswa);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_monitoring_anak) {
            fragmentClass = TabMonitoringSiswaFragment.class;
        } else if (id == R.id.nav_absensi_siswa) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_notifikasi_tagihan_siswa) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_lihat_tagihan_siswa) {
            fragmentClass = ProfilSiswaFragment.class;

        } else if (id == R.id.nav_payment_tagihan) {
            fragmentClass = ProfilSiswaFragment.class;
